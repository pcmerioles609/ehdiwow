...
public class DeviceScanActivity extends ListActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!mScanning) {
            ...
            if (deviceCount > 0)
                getActionBar().setTitle(String.valueOf(deviceCount) + " Device Found");
            else
                getActionBar().setTitle(R.string.txt_notFound);
        } else {
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = mInflator.inflate(R.layout.list_tester_devices,null);
